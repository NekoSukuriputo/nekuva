...
import org.nekosukuriputo.nekuva.core.util.ext.ensureSuccess
import org.nekosukuriputo.nekuva.parsers.util.await
import org.nekosukuriputo.nekuva.parsers.util.isHttpOrHttps
...
abstract class BaseImageProxyInterceptor : ImageProxyInterceptor {
	...
	private fun logDebug(e: Throwable, url: Any) {
		if (false) {
			println("ImageProxy: ${e.message}: $url - $e")
		}
	}
