...
import org.nekosukuriputo.nekuva.core.db.sqlEscapeString
...
import org.nekosukuriputo.nekuva.core.db.MangaQueryBuilder
import org.nekosukuriputo.nekuva.core.db.TABLE_FAVOURITES
import org.nekosukuriputo.nekuva.core.db.entity.MangaWithTags
import org.nekosukuriputo.nekuva.favourites.domain.model.Cover
...
abstract class FavouritesDao : MangaQueryBuilder.ConditionCallback {
	...
	suspend fun findCovers(categoryId: Long, order: ListSortOrder): List<Cover> {
		...
		) { stmt -> stmt.bindLong(1, categoryId) }
	...
	suspend fun findCovers(order: ListSortOrder, limit: Int): List<Cover> {
		...
		) { stmt -> stmt.bindLong(1, limit.toLong()) }
		return findCoversImpl(query)
	}
	...
	protected abstract fun observeAllImpl(query: RoomRawQuery): Flow<List<FavouriteManga>>

	@RawQuery
	protected abstract suspend fun findCoversImpl(query: RoomRawQuery): List<Cover>
