...
fun SettingsRootScreen(
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(padding).verticalScroll(rememberScrollState())) {
            ...
            SettingsItem(title = stringResource(Res.string.reader_settings), icon = Icons.AutoMirrored.Outlined.MenuBook, summary = soon, enabled = false)
            SettingsItem(title = stringResource(Res.string.storage_and_network), icon = Icons.Outlined.Storage, summary = soon, enabled = false)
