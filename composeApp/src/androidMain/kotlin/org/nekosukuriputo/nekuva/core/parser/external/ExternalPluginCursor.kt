...
import org.nekosukuriputo.nekuva.core.exceptions.IncompatiblePluginException
...
class ExternalPluginCursor(private val source: ExternalMangaSource, cursor: Cursor) : CursorWrapper(cursor) {
	...
	fun getBoolean(columnName: String): Boolean = getInt(getColumnIndexOrThrow(columnName)) == 1
