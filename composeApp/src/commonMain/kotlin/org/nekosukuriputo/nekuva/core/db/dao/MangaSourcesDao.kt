package org.nekosukuriputo.nekuva.core.db.dao
...
import org.nekosukuriputo.nekuva.parsers.network.CloudFlareHelper.PROTECTION_CAPTCHA
...
abstract class MangaSourcesDao {
	...
	protected abstract fun observeImpl(query: RoomRawQuery): Flow<List<MangaSourceEntity>>

	@RawQuery
	protected abstract suspend fun findAllImpl(query: RoomRawQuery): List<MangaSourceEntity>
	...
	private fun getQuery(enabledOnly: Boolean, order: SourcesSortOrder) = RoomRawQuery(
		buildString {
